...
<https://github.com/IfcOpenShell/IfcOpenShell/tree/v0.9.0/src/ifcopenshell-python/docs>`_.
...
.. tip::
   ...
   <https://github.com/IfcOpenShell/IfcOpenShell/blob/v0.9.0/src/ifcopenshell-python/docs/conf.py#L69>`_
   to make this faster
