...
class triangulation_element(element):
    ...
    @property
    def geometry_pointer(self) -> triangulation: ...
...
class tree:
    ...
    def select_ray(self, origin, direction, length=1000.0) -> ray_intersection_results: ...
...
def create_tree(backend_id: str) -> tree: ...
