...
.. container:: blockbutton
    ...
    `Download Source
    <https://github.com/IfcOpenShell/IfcOpenShell/archive/refs/heads/v0.9.0.zip>`__
...
- `Bonsai modules <https://github.com/IfcOpenShell/IfcOpenShell/tree/v0.9.0/src/bonsai/bonsai/bim/module>`__
- `IFC modules <https://github.com/IfcOpenShell/IfcOpenShell/tree/v0.9.0/src/ifcopenshell-python/ifcopenshell/api>`__
...
- `ifcopenshell (core) <https://github.com/IfcOpenShell/IfcOpenShell/tree/v0.9.0/src/ifcopenshell-python/ifcopenshell>`__
- `ifcopenshell.util <https://github.com/IfcOpenShell/IfcOpenShell/tree/v0.9.0/src/ifcopenshell-python/ifcopenshell/util>`__
- `ifcopenshell.api <https://github.com/IfcOpenShell/IfcOpenShell/tree/v0.9.0/src/ifcopenshell-python/ifcopenshell/api>`__
