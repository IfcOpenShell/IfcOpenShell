...
def register():
    if not bpy.app.background:
        ...
        bpy.utils.register_tool(workspace.TransportElementTool, after={"bim.ramp_tool"}, separator=False, group=False)
        ...
        bpy.utils.register_tool(workspace.FootingTool, after={"bim.member_tool"}, separator=False, group=False)
