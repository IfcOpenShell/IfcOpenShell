...
def register():
    if not bpy.app.background:
        ...
        bpy.utils.register_tool(workspace.StairTool, after={"bim.roof_tool"}, separator=False, group=False)
        bpy.utils.register_tool(workspace.StairFlightTool, after={"bim.stair_tool"}, separator=False, group=False)
        bpy.utils.register_tool(workspace.RampTool, after={"bim.stair_flight_tool"}, separator=False, group=False)
        bpy.utils.register_tool(workspace.RampFlightTool, after={"bim.ramp_tool"}, separator=False, group=False)
