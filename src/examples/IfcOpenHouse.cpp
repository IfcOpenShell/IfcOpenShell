...
//
//
//	BRepTools::Write(face_compound, "spaceses.brep");
//
//
//
//
...
//			TopoDS_Shape shape1 = thickened_face(face1, 0.1); 
//			TopoDS_Shape shape2 = thickened_face(face2, 0.1);
//
//
//
//			
...
//
//
//	compound_builder.Add(face_compound, store_wall_faces);
//
//
//
//	BRepTools::Write(face_compound, "ALLIN6.brep");
//
//
//	myfile.close();
//}
