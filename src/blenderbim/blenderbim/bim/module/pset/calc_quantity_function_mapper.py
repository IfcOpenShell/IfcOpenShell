mapper = {
    ...
    'Qto_WallBaseQuantities' : {
        ...
        'GrossSideArea' : { "function_name" : "get_lateral_area", "args" : ", exclude_end_areas = True, subtract_openings = False" },
        'NetSideArea' : { "function_name" : "get_lateral_area", "args" : ", exclude_end_areas = True" },
