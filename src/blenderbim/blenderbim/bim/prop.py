...
class ModuleVisibility(PropertyGroup):
    aggregate: BoolProperty(default=True)
    attribute: BoolProperty(default=True)
    augin: BoolProperty(default=True)
    bcf: BoolProperty(default=True)
    bimtester: BoolProperty(default=True)
    boundary: BoolProperty(default=True)
    clash: BoolProperty(default=True)
    classification: BoolProperty(default=True)
    cobie: BoolProperty(default=True)
    constraint: BoolProperty(default=True)
    context: BoolProperty(default=True)
    cost: BoolProperty(default=True)       
    covetool: BoolProperty(default=True)
    csv: BoolProperty(default=True)
    debug: BoolProperty(default=True)
    diff: BoolProperty(default=True)
    document: BoolProperty(default=True)
    #DATA drawing: BoolProperty(default=True)
    geometry: BoolProperty(default=True)
    georeference: BoolProperty(default=True)
    group: BoolProperty(default=True)
    layer: BoolProperty(default=True)
    lca: BoolProperty(default=True)
    #MATERIAL material: BoolProperty(default=True)
    #VIEW3D model: model: BoolProperty(default=True)
    owner: BoolProperty(default=True)
    patch: BoolProperty(default=True)
    profile: BoolProperty(default=True)
    project: BoolProperty(default=True)
    pset_template: BoolProperty(default=True)
    pset: BoolProperty(default=True)
    qto: BoolProperty(default=True)
    resource: BoolProperty(default=True)
    root: BoolProperty(default=True)
    search: BoolProperty(default=True)
    sequence: BoolProperty(default=True)
    spatial: BoolProperty(default=True)
    structural: BoolProperty(default=True)
    style: BoolProperty(default=True)
    system: BoolProperty(default=True)
    type: BoolProperty(default=True)
    unit: BoolProperty(default=True)
    void: BoolProperty(default=True)