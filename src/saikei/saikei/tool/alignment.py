...
class Alignment:
    ...
    @classmethod
    def create_object_for_alignment(
        cls,
    ...
    def create_object_for_layout(
        cls,
        layout_entity: ifcopenshell.entity_instance,
    ...
    def create_object_for_segment(
        ...
        try:
            ...
            if seg_type == "LINE":
                obj = cls._create_line_segment(
                    name, start_point, start_direction, seg_length
                )
                ...
                if radius is None or radius == 0:
                    ...
                    obj = cls._create_arc_segment(
                        name, start_point, start_direction, seg_length, radius
                    )
            else:
    ...
    @classmethod
    def create_hierarchy_for_alignment(
        cls,
        alignment: ifcopenshell.entity_instance
    ) -> Optional[bpy.types.Object]:
    ...
    @classmethod
    def remove_layout_segment_objects(
        cls,
        layout: ifcopenshell.entity_instance
    ) -> int:
    ...
    @classmethod
    def remove_alignment_hierarchy(
        cls,
        alignment: ifcopenshell.entity_instance
    ) -> int:
    ...
    def refresh_layout_visualization(
        cls,
        layout: ifcopenshell.entity_instance,
        layout_obj: Optional[bpy.types.Object] = None
    ) -> List[bpy.types.Object]:
