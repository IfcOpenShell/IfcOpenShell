...
#define IFCAPI_CONSTRUCTOR_PARAM(expose_as, source_name, public_name, cpp_type)
#define IFCAPI_DISCOVER_POLICY(handle, operation, ...)
#define IFCAPI_INT32(cpp_type) cpp_type
#define IFCAPI_RESULT_STRUCT(...)

#endif // IFCWRAP_BINDING_GENERATOR_SPEC_MACROS_H
