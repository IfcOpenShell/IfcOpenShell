...
extern "C" void emscripten_register_document_serializer_plugin(ifcopenshell::serializers::document_serializer_registry* registry) {
	ifcopenshell::serializers::json_document_serializer_plugin::register_plugin(
		*registry,
		ifcopenshell::plugin::module::builtin(ifcopenshell::serializers::json_document_serializer_plugin::plugin_metadata()));
}
#endif
