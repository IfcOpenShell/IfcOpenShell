...
extern "C" void emscripten_register_geometry_serializer_plugin(ifcopenshell::serializers::geometry_serializer_registry* registry) {
	ifcopenshell::serializers::geometry_stp_plugin::register_plugin(
		*registry,
		ifcopenshell::plugin::module::builtin(ifcopenshell::serializers::geometry_stp_plugin::plugin_metadata()));
}
#endif
