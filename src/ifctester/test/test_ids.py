...
class TestIdsParsing(unittest.TestCase):
    ...
    def test_parse_entity_facet(self):
        ...
        ids_file = ids.open(IDS_URL)
        self.assertEqual(ids_file.specifications[0].requirements[0].node["name"]["simpleValue"], "IfcWall")
    ...
    def test_parse_predefinedType_facet(self):
        ...
        ids_file = ids.open(IDS_URL)
        self.assertEqual(
            ids_file.specifications[0].requirements[0].node["predefinedType"]["simpleValue"], "CLADDING"
        )
    ...
    def test_parse_property_facet(self):
        ...
        self.assertEqual(ids_file.specifications[0].requirements[0].node["name"]["simpleValue"], "Test_Parameter")
        self.assertEqual(ids_file.specifications[0].requirements[0].node["value"]["simpleValue"], "Test_Value")
    ...
    def test_parse_material_facet(self):
        ...
        ids_file = ids.open(IDS_URL)
        self.assertEqual(ids_file.specifications[0].requirements[0].node["value"]["simpleValue"], "Test_Material")
    ...
    def test_parse_classification_facet(self):
        ...
        ids_file = ids.open(IDS_URL)
        self.assertEqual(
            ids_file.specifications[0].requirements[0].node["value"]["simpleValue"], "Test_Classification"
        )
        self.assertEqual(ids_file.specifications[0].requirements[0].node["system"]["simpleValue"], "Test_System")
    ...
    def test_parse_restrictions_enumeration(self):
        ...
        self.assertEqual(
            [
                x["@value"]
                for x in ids_file.specifications[0].requirements[0].node["value"]["restriction"][0]["enumeration"]
            ],
            ["testA", "testB"],
        )
    ...
    def test_parse_restrictions_bounds(self):
        ...
        self.assertEqual(ids_file.specifications[0].requirements[0].node["name"]["simpleValue"], "Test_Parameter")
        self.assertEqual(
            ids_file.specifications[0].requirements[0].node["value"]["restriction"][0]["minInclusive"]["@value"],
            "0",
        )
    ...
    def test_parse_restrictions_pattern_simple(self):
        ...
        self.assertEqual(ids_file.specifications[0].requirements[0].node["name"]["simpleValue"], "Test_Parameter")
        self.assertEqual(
            ids_file.specifications[0].requirements[0].node["value"]["restriction"][0]["pattern"]["@value"],
            "[A-Z]{2,4}",
        )
...
class TestIdsAuthoring(unittest.TestCase):
    ...
    def test_creating_an_entity_facet(self):
        facet = ids.Entity(name="IfcName")
        assert facet.asdict() == {"name": {"simpleValue": "IfcName"}}
        facet = ids.Entity(name="IfcName", predefinedType="predefinedType", instructions="instructions")
        assert facet.asdict() == {
    ...
    def test_filtering_using_an_entity_facet(self):
        ...
        facet = ids.Entity(name="IFCWALL", predefinedType="SOLIDWALL")
        ifc = ifcopenshell.file()
        run(
        ...
        facet = ids.Entity(name="IFCWALL", predefinedType="WALDO")
        ifc = ifcopenshell.file()
        run(
        ...
        facet = ids.Entity(name="IFCWALLTYPE", predefinedType="WALDO")
        ifc = ifcopenshell.file()
        run(
        ...
        facet = ids.Entity(name="IFCTASKTYPE", predefinedType="TASKY")
        ifc = ifcopenshell.file()
        run(
        ...
        facet = ids.Entity(name="IFCWALL", predefinedType="USERDEFINED")
        ifc = ifcopenshell.file()
        run(
        ...
        facet = ids.Entity(name="IFCWALL", predefinedType="X")
        ...
        restriction = ids.Restriction(options=["IFCWALL", "IFCSLAB"], type="enumeration")
        facet = ids.Entity(name=restriction)
        ifc = ifcopenshell.file()
        ...
        restriction = ids.Restriction(options="IFC.*TYPE", type="pattern")
        facet = ids.Entity(name=restriction)
        ifc = ifcopenshell.file()
        ...
        restriction = ids.Restriction(options="FOO.*", type="pattern")
        facet = ids.Entity(name="IFCWALL", predefinedType=restriction)
        ifc = ifcopenshell.file()
    ...
    def test_creating_an_attribute_facet(self):
        attribute = ids.Attribute(name="name")
        assert attribute.asdict() == {"name": {"simpleValue": "name"}}
        attribute = ids.Attribute(name="name", value="value")
    ...
    def test_filtering_using_an_attribute_facet(self):
        ...
        facet = ids.Attribute(name="CountValue")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="IsCritical")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="RelatingPriorities")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="LayerStyles")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="TaskTime")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="DiffuseColour")
        ifc = ifcopenshell.file()
        ...
        ifc = ifcopenshell.file()
        facet = ids.Attribute(name="EngagedIn")
        ...
        facet = ids.Attribute(name="Name", value="Foobar")
        ifc = ifcopenshell.file()
        ...
        ifc = ifcopenshell.file()
        facet = ids.Attribute(name="Name", value="♫")
        run("Non-ascii characters are treated without encoding", facet=facet, inst=ifc.createIfcWall(Name="♫"), expected=True)

        facet = ids.Attribute(name="TaskTime", value="Foobar")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="DiffuseColour", value="Foobar")
        ifc = ifcopenshell.file()
        rgb = ifc.createIfcColourRgb(None, 1, 1, 1)
        ...
        facet = ids.Attribute(name="Coordinates", value="Foobar")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="GlobalId", value=global_id)
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="Identification", value=identifier + "_extra_characters")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="RefractionIndex", value="42")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="RefractionIndex", value="42.0")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="RefractionIndex", value="42,3")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="RefractionIndex", value="123,4.5")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="RefractionIndex", value="1.2345e3")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="IsMilestone", value="TRUE")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="IsMilestone", value="FALSE")
        ...
        facet = ids.Attribute(name="EditionDate", value="2022-01-01")
        ifc = ifcopenshell.file()
        ...
        facet = ids.Attribute(name="ScheduleDuration", value="PT16H")
        ifc = ifcopenshell.file()
        ...
        restriction = ids.Restriction(options=".*Name.*", type="pattern")
        facet = ids.Attribute(name=restriction)
        ifc = ifcopenshell.file()
        ...
        restriction = ids.Restriction(options=["Name", "Description"], type="enumeration")
        facet = ids.Attribute(name=restriction)
        ifc = ifcopenshell.file()
        ...
        restriction = ids.Restriction(options=["Foo", "Bar"], type="enumeration")
        facet = ids.Attribute(name="Name", value=restriction)
        ifc = ifcopenshell.file()
        ...
        restriction = ids.Restriction(options=["42"], type="enumeration", base="string")
        facet = ids.Attribute(name="RefractionIndex", value=restriction)
        ifc = ifcopenshell.file()
    ...
    def test_creating_a_classification_facet(self):
        ...
        assert facet.asdict() == {}
        facet = ids.Classification(value="value", system="system")
    ...
    def test_filtering_using_a_classification_facet(self):
        ...
        facet = ids.Classification(system="Foobar")
        ...
        restriction = ids.Restriction(options="1.*", type="pattern")
        facet = ids.Classification(value=restriction)
        ...
        restriction = ids.Restriction(options="Foo.*", type="pattern")
        facet = ids.Classification(system=restriction)
        ...
        facet = ids.Classification(system="Foobar", value="1")
    ...
    def test_filtering_using_a_property_facet(self):
        ...
        # The logic is that unfortunately most BIM users cannot differentiate between the two.
        facet = ids.Property(propertySet="Foo_Bar", name="Foo")
        ...
        facet = ids.Property(propertySet="Foo_Bar", name="Foo", value="Bar")
        element = ifcopenshell.api.run("root.create_entity", ifc, ifc_class="IfcWall")
        pset = ifcopenshell.api.run("pset.add_pset", ifc, product=element, name="Foo_Bar")
        ifcopenshell.api.run("pset.edit_pset", ifc, pset=pset, properties={"Foo": "Bar"})
        run("", facet=facet, inst=element, expected=True)
        ...
        facet = ids.Property(propertySet="Foo_Bar", name="Foo", value="1")
        element = ifcopenshell.api.run("root.create_entity", ifc, ifc_class="IfcWall")
        pset = ifcopenshell.api.run("pset.add_pset", ifc, product=element, name="Foo_Bar")
        ...
        restriction = ids.Restriction(options="Foo_.*", type="pattern")
        facet = ids.Property(propertySet=restriction, name="Foo")
        element = ifcopenshell.api.run("root.create_entity", ifc, ifc_class="IfcWall")
        pset = ifcopenshell.api.run("pset.add_pset", ifc, product=element, name="Foo_Bar")
        ifcopenshell.api.run("pset.edit_pset", ifc, pset=pset, properties={"Foo": "Bar"})
        run("", facet=facet, inst=element, expected=True)
        ...
        restriction = ids.Restriction(options="Foo.*", type="pattern")
        facet = ids.Property(propertySet="Foo_Bar", name=restriction, value="x")
        element = ifcopenshell.api.run("root.create_entity", ifc, ifc_class="IfcWall")
        pset = ifcopenshell.api.run("pset.add_pset", ifc, product=element, name="Foo_Bar")
        ...
        restriction1 = ids.Restriction(options="Foo.*", type="pattern")
        restriction2 = ids.Restriction(options=["x", "y"], type="enumeration")
        facet = ids.Property(propertySet="Foo_Bar", name=restriction1, value=restriction2)
        element = ifcopenshell.api.run("root.create_entity", ifc, ifc_class="IfcWall")
        pset = ifcopenshell.api.run("pset.add_pset", ifc, product=element, name="Foo_Bar")
        ifcopenshell.api.run("pset.edit_pset", ifc, pset=pset, properties={"Foobar": "x", "Foobaz": "y"})
        run("", facet=facet, inst=element, expected=True)
        ...
        restriction = ids.Restriction(options=[42.12], type="enumeration", base="decimal")
        facet = ids.Property(propertySet="Foo_Bar", name="Foobar", value=restriction)
        element = ifcopenshell.api.run("root.create_entity", ifc, ifc_class="IfcWall")
        pset = ifcopenshell.api.run("pset.add_pset", ifc, product=element, name="Foo_Bar")
        ifcopenshell.api.run("pset.edit_pset", ifc, pset=pset, properties={"Foobar": 42.12})
        run("", facet=facet, inst=element, expected=True)
        restriction = ids.Restriction(options=[42], type="enumeration", base="integer")
        facet = ids.Property(propertySet="Foo_Bar", name="Foobar", value=restriction)
        run("", facet=facet, inst=element, expected=False)
        ifcopenshell.api.run("pset.edit_pset", ifc, pset=pset, properties={"Foobar": 42})
        run("", facet=facet, inst=element, expected=True)
        restriction = ids.Restriction(options=[True], type="enumeration", base="boolean")
        facet = ids.Property(propertySet="Foo_Bar", name="Foobar", value=restriction)
        run("", facet=facet, inst=element, expected=False)
        ...
        restriction = ids.Restriction(options=[2], type="enumeration", base="decimal")
        facet = ids.Property(propertySet="Foo_Bar", name="Foo", value=restriction, measure="Time")
        element = ifcopenshell.api.run("root.create_entity", ifc, ifc_class="IfcWall")
        pset = ifcopenshell.api.run("pset.add_pset", ifc, product=element, name="Foo_Bar")
        ...
        restriction = ids.Restriction(options=[2], type="enumeration", base="decimal")
        facet = ids.Property(propertySet="Foo_Bar", name="Foo", value=restriction, measure="Length")
        element = ifcopenshell.api.run("root.create_entity", ifc, ifc_class="IfcWall")
        pset = ifcopenshell.api.run("pset.add_pset", ifc, product=element, name="Foo_Bar")
    ...
    def test_filtering_using_a_material_facet(self):
        ...
        run("Any constituent Name in a constituent set will pass a value check", facet=facet, inst=element, expected=True)
        constituent.Name = "Bar"
        constituent.Category = "Foo"
        run("Any constituent Category in a constituent set will pass a value check", facet=facet, inst=element, expected=True)
        ...
        material.Name = "Bar"
        material.Category = "Foo"
        run("Any material Category in a constituent set will pass a value check", facet=facet, inst=element, expected=True)
    ...
    def test_creating_a_partof_facet(self):
        ...
        facet = ids.PartOf(entity="IfcGroup")
    ...
    def test_filtering_using_a_partof_facet(self):
        ...
        facet = ids.PartOf(entity="IfcElementAssembly")
        run("", facet=facet, inst=element, expected=False)
        ...
        facet = ids.PartOf(entity="IfcSystem")
        run("", facet=facet, inst=element, expected=False)
    ...
    def test_create_restrictions_enumeration(self):
        ...
        i.specifications[0].applicability.append(ids.Entity(name="Test_Name"))
        r = ids.Restriction(options=["testA", "testB"], type="enumeration")
        m = ids.Material(value=r)
        i.specifications[0].requirements.append(m)
        self.assertEqual(i.specifications[0].requirements[0].value, "testA")
        self.assertEqual(i.specifications[0].requirements[0].value, "testB")
        self.assertNotEqual(i.specifications[0].requirements[0].value, "testC")

    def test_create_restrictions_bounds(self):
        i = ids.Ids(title="My IDS")
        i.specifications.append(ids.Specification(name="Test_Specification"))
        i.specifications[0].applicability.append(ids.Entity(name="Test_Name"))
        r = ids.Restriction(options={"minInclusive": 0, "maxExclusive": 10}, type="bounds", base="integer")
        p = ids.Property(propertySet="Test", name="Test", value=r)
        i.specifications[0].requirements.append(p)
        self.assertEqual(i.specifications[0].requirements[0].value, 0)
        self.assertEqual(i.specifications[0].requirements[0].value, 5)
        self.assertNotEqual(i.specifications[0].requirements[0].value, -1)
        self.assertNotEqual(i.specifications[0].requirements[0].value, 10)

    def test_create_restrictions_pattern_simple(self):
        i = ids.Ids(title="My IDS")
        i.specifications.append(ids.Specification(name="Test_Specification"))
        i.specifications[0].applicability.append(ids.Entity(name="Test_Name"))
        r = ids.Restriction(options="[A-Z]{2,4}", type="pattern")
        p = ids.Property(propertySet="Test", name="Test", value=r)
        i.specifications[0].requirements.append(p)
        self.assertEqual(i.specifications[0].requirements[0].value, "XYZ")
        self.assertNotEqual(i.specifications[0].requirements[0].value, "abc")
        self.assertNotEqual(i.specifications[0].requirements[0].value, "ABCDE")
        self.assertNotEqual(i.specifications[0].requirements[0].value, "A")

    def test_create_restrictions_pattern_advanced(self):
        i = ids.Ids(title="My IDS")
        i.specifications.append(ids.Specification(name="Test_Specification"))
        i.specifications[0].applicability.append(ids.Entity(name="Test_Name"))
        r = ids.Restriction(options="(Wanddurchbruch|Deckendurchbruch).*", type="pattern")
        p = ids.Property(propertySet="Test", name="Test", value=r)
        i.specifications[0].requirements.append(p)
        self.assertEqual(i.specifications[0].requirements[0].value, "Wanddurchbruch")
        self.assertEqual(i.specifications[0].requirements[0].value, "Deckendurchbruch")
        self.assertNotEqual(i.specifications[0].requirements[0].value, "Deeckendurchbruch")

    def test_create_restrictions_pattern_utf(self):
        i = ids.Ids(title="My IDS")
        i.specifications.append(ids.Specification(name="Test_Specification"))
        i.specifications[0].applicability.append(ids.Entity(name="Test_Name"))
        r = ids.Restriction(options="èêóòâôæøåążźćęóʑʒʓʔʕʗʘʙʚʛʜʝʞ", type="pattern")
        p = ids.Property(propertySet="Test", name="Test", value=r)
        i.specifications[0].requirements.append(p)
        self.assertEqual(i.specifications[0].requirements[0].value, "èêóòâôæøåążźćęóʑʒʓʔʕʗʘʙʚʛʜʝʞ")

    def test_created_ids_to_xml(self):
        i = ids.Ids(title="My IDS")
        i.specifications.append(ids.Specification(name="Test_Specification"))
        e = ids.Entity(name="Test_Name", predefinedType="Test_PredefinedType")
        c = ids.Classification(value="Test_Value", system="Test_System")
        m = ids.Material(value="Test_Value")
        re = ids.Restriction(options=["testA", "testB"], type="enumeration")
        rb = ids.Restriction(options={"minInclusive": 0, "maxExclusive": 10}, type="bounds", base="integer")
        rp1 = ids.Restriction(options="[A-Z]{2,4}", type="pattern")
        rp2 = ids.Restriction(options="èêóòâôæøåążźćęóʑʒʓʔʕʗʘʙʚʛʜʝʞ", type="pattern")
        p1 = ids.Property(propertySet="Test_PropertySet", name="Test_Parameter", value=re)
        p2 = ids.Property(propertySet="Test_PropertySet", name="Test_Parameter", value=rb)
        p3 = ids.Property(propertySet="Test_PropertySet", name="Test_Parameter", value=rp1)
        p4 = ids.Property(propertySet="Test_PropertySet", name="Test_Parameter", value=rp2)
        p5 = ids.Property(propertySet="Test_PropertySet", name="Test_Parameter", value=[re, rb, rp1])
        i.specifications[0].applicability.append(e)
        i.specifications[0].applicability.append(m)
        i.specifications[0].requirements.append(c)
        i.specifications[0].requirements.append(p1)
        i.specifications[0].requirements.append(p2)
        i.specifications[0].requirements.append(p3)
        i.specifications[0].requirements.append(p4)
        i.specifications[0].requirements.append(p5)
        fn = "TEST_FILE.xml"
        result = i.to_xml(fn)
        os.remove(fn)
        self.assertTrue(result)
...
class TestIfcValidation(unittest.TestCase):
    ...
    def test_validate_all_facets(self):
        # Those are true:
        e = ids.Entity(name="IfcWall")
        p1 = ids.Property(propertySet="MySet", name="Param1", value="banan")
        p2 = ids.Property(propertySet="MySet", name="Param2", value=120.0)
        p3 = ids.Property(propertySet="Pset_WallCommon", name="LoadBearing", value=False)
        # Those are false:
        p4 = ids.Property(propertySet="MySet", name="Param1", value="orange")
        p5 = ids.Property(propertySet="MySet", name="Param2", value=123.4)
        p6 = ids.Property(propertySet="Pset_WallCommon", name="LoadBearing", value=True)
        ...
        i.specifications[0].requirements.append(p4)
        i.specifications[0].requirements.append(p5)
        i.specifications[0].requirements.append(p6)
