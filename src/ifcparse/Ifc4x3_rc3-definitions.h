...
#define SCHEMA_HAS_IfcVienneseBend
#define SCHEMA_IfcVienneseBend_HAS_StartCurvature
#define SCHEMA_IfcVienneseBend_HAS_EndCurvature
#define SCHEMA_IfcVienneseBend_HAS_GravityCenterHeight
#define SCHEMA_IfcVienneseBend_HAS_SegmentLength
