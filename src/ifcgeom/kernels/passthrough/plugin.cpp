...
extern "C" void emscripten_register_kernel_plugin(ifcopenshell::geom::kernels::kernel_registry* registry) {
	ifcopenshell::geom::kernels::passthrough_plugin::register_plugin(
		*registry,
		ifcopenshell::plugin::module::builtin(ifcopenshell::geom::kernels::passthrough_plugin::plugin_metadata()));
}
#endif
