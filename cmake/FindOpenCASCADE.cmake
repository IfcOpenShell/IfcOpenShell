...
target_include_directories(OpenCASCADE_INTERFACE INTERFACE "$<BUILD_INTERFACE:${OCC_INCLUDE_DIR}>")
target_link_libraries(OpenCASCADE_INTERFACE INTERFACE ${OpenCASCADE_LIBRARIES})
target_link_directories(OpenCASCADE_INTERFACE INTERFACE "$<BUILD_INTERFACE:${OCC_LIBRARY_DIR}>")
